...
In dit document leggen wij, als team, onze afspraken vast over hoe we samenwerken, communiceren en omgaan met verantwoordelijkheden en conflicten tijdens het SE-project The Game. Door deze afspraken schriftelijk te maken en gezamenlijk te ondertekenen, zorgen we voor een veilige en productieve werkomgeving waarin ieders stem wordt gehoord en gerespecteerd.

We gaan gedurende **3 sprints** aan de slag met het ontwerpen, realiseren en testen van een game in de context van Software Engineering. Dit samenwerkingscontract dient als leidraad en kan gaandeweg in overleg worden aangepast als daar unanieme behoefte aan is.
...
Buiten de les: Check In / Out in Discord.
...
- **Keuzes**: Bij het maken van keuzes geldt meeste stemmen gelden. Indien een overeenkomst onmogelijk is schakelen we de docent in.
